...
- Open `project_vars.R`  
- Replace the file paths and directory locations at the start of each
  script to match your computer
- Set the TreeMap vintage in Script 1 based on the year of your
  treatments
- Define the project name, treatment name, and shapefile name<br><br>
...
- In cases where impact areas within a project overlap, Script 1 does
  ...
  Overlapping Treatment Areas)<br><br>
...
- This is only necessary for TCNs that Script 1 identified as needing
  impact area analysis
- See section **C. Fuels Reduction FVS Procedure–Impact Area**<br><br>
...
- In Script 3, set `end_year` based on project duration (see Calculator
  Tool)<br><br>
