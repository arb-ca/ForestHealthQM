...
for(i in 1:nrow(buff_combined)){
  ...
  st_write(intersected_sf_buff, triaads_output_dir, paste("intersected_IA",  project_ID, shp_buff_sf$TCN, sep = "_"), driver = "ESRI Shapefile", delete_layer = T, quiet = T)
