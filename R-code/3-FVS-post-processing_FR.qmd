...
## Treatment = `3.3`
## Shapefile = `71399131_3_3_20250110_region.shp`
...
```{r}
fvs_output_dir = "~/../../Data_heavy_projects/Forest_QM_automation/FVS_Output/8GG24601"
areas_dir <- "~/../../Data_heavy_projects/Forest_QM_automation/temp"
```

## Load the FVS output files
```{r}
df <- read_excel(paste0(fvs_output_dir, "/8GG24601_3.3_carbon.xlsx"))
```

## Load the data tables with areas
```{r}
areas <- read_excel(paste0(areas_dir, "/8GG24601_3.3_areas.xlsx"))
```
