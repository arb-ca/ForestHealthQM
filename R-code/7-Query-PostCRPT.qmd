...
# This run is for project `8GG20600`
## TCN = `7.1`
...
```{r}
shp_path <- "~/CCI/QMs/Forest Health QM/Test runs/reforestation/8GG20600/8GG20600_CloseoutShapefiles/8GG20600_7_1_20250417.shp"
```
...
```{r}
fvs_path <- "C:/Users/ctubbesi/Data_heavy_projects/Forest_QM_automation/FVS_input/FVS_input_IA_8GG20600_7_1_20250417.xlsx"
```
