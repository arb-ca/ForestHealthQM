...
# TEST GIT WITH LILLIAN

```{r}
proj_name <- "Hughes CFIP"
```
...
### Original treatment shapefiles 
```{r}
trt_dir <- "~/../OneDrive - California Air Resources Board/documents/CCI/QMs/Forest Health QM/QM Runs 2025/CFIP/8GG25301 Hughes Family Trust/shapefile/"
```
...
This is the probability expressed as a percentage. For example, 0.07 is a 0.07% or 0.0007 probability. 